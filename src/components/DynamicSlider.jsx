...
const videoData = [
     ...
     {
          video: videoStart, title: "Welcome El Heba For Agricultural Development"
     },
];
...
const DynamicVideoPlayer = () => {
     ...
     return (
          <section className="relative sm:h-[80vh]  lg:h-screen w-full">
               ...
               <div className="absolute bottom-[100px] left-1/2 transform -translate-x-1/2 gap-3 z-40 grid sm:grid-cols-1 lg:grid-cols-2">
                    ...
                    >
                         <Link to="/contact" className="animation" title="Contact us for more information">
                              Contact US
                         </Link>
                    </button>
               </div>
