        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="bg-white shadow-2xl rounded p-8">
            <div className="flex justify-center items-center">
              <img className="w-40 " src={pngLogo} alt="" />  </div>          
            <p className="text-gray-700 leading-relaxed mb-6">
              El-Heba Company specializes in the production, packaging, and export
              of fresh and frozen fruits, as well as frozen vegetables, to markets
              worldwide.
            </p>
